...
{% macro listItem(media) %}
	...
	{% endif %}
	{% set icnPth = 'gfn-tarheel/assets/icons/' ~ media.type|lower ~ '.png' %}
	<li><img src="{{ icnPth|url }}" alt="" /> <a href="{{ URL }}">{{ media.title ? media.title : media.base_name }}</a></li>
{% endmacro %}
